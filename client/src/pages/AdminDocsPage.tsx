...
export default function AdminDocsPage() {
  ...
  return (
    <div className="site-shell min-h-screen bg-paper text-ink" dir="rtl">
      <header className="site-header site-header--scrolled border-b border-line bg-white/90 px-8 py-4 backdrop-blur-md flex justify-between items-center"><a className="brand flex items-center gap-3" href="/"><span className="brand-copy"><strong className="font-kufi text-falaj-deep">لوحة وثائق ومواصفات MVP</strong><small className="text-[11px] text-muted">منصة واحات ومزارع عُمان 2040</small></span></a><div className="flex items-center gap-3"><NotificationCenter /><a href="/" className="flex items-center gap-1 text-xs font-bold text-falaj hover:underline">العودة للواجهة الرئيسية <ArrowRight size={14} /></a></div></header>
